...
public class SegmentCross3 {
    ...
    static void OnePointCover (SegCross3_Line a, SegCross3_Line b) throws IOException {
        if(a.p1.compare(b.p1)){
            if(slope(a.p1, b.p2) != slope(a.p1, a.p2))
                bw.write("\n" + (double)a.p1.x + " " + (double)a.p1.y);
